...
TCP/IP fingerprint:
OS:SCAN(V=7.94%E=4%D=10/22%OT=22%CT=1%CU=36121%PV=Y%DS=2%DC=T%G=Y%TM=6534AD
OS:F1%P=x86_64-unknown-linux-gnu)SEQ(SP=100%GCD=1%ISR=10B%TI=Z%CI=Z%II=I%TS
OS:=A)SEQ(SP=100%GCD=1%ISR=10C%TI=Z%CI=Z%II=I%TS=A)OPS(O1=M53CST11NW7%O2=M5
...
Uptime guess: 23.193 days (since Thu Sep 28 20:28:52 2023)
...
HOP RTT       ADDRESS
1   143.50 ms 10.10.14.1
2   143.68 ms pilgrimage.htb (10.10.11.219)
...
Nmap done: 1 IP address (1 host up) scanned in 27.33 seconds
           Raw packets sent: 1133 (53.990KB) | Rcvd: 1091 (47.274KB)
=========================================================================================================
