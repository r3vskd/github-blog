#define NGX_CONFIGURE " --add-module=/home/l4b/Downloads/HTB_academy/server-side-attacks-module/nginx-1.21.3/../nginx_ajp_module --prefix=/etc/nginx --sbin-path=/usr/sbin/nginx --modules-path=/usr/lib/nginx/modules"
...
#ifndef NGX_HTTP_AJP_TEMP_PATH
#define NGX_HTTP_AJP_TEMP_PATH  "ajp_temp"
#endif


#ifndef NGX_AJP_MODULE
#define NGX_AJP_MODULE  1
#endif
