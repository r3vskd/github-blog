...
parser.add_argument("-t", "--target", help="Specify the target host E.g. http://10.129.123.156:3001/uploads/backdoor.php", required=True) # specifies flags such as -t for a target with a help and required option being true
...
parser.add_argument("-o", "--option", help="Interactive Web Shell with loop usage: python3 web_shell.py -t http://10.129.123.156:3001/uploads/backdoor.php -o yes") # similar to above
